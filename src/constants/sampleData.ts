...
const featuredSpots: Spot[] = [
  {
    ...
    description: 'A Cebu nightlife test spot for validating venue details, reservations, owner approvals, and GCash payments.',
    category: 'Club',
    categories: ['Club', 'Nightlife', 'Reservations'],
    ...
    gcash_qr_url: 'https://api.qrserver.com/v1/create-qr-code/?size=420x420&data=GCash%20Test%20Cebspot%20Club%2009175550198%20150',
    gcash_amount: 150,
